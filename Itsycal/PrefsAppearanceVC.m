...
- (void)loadView
{
    ...
    NSStackView *countdownSliderRow = [NSStackView stackViewWithViews:@[countdownWidthMinLabel, countdownWidthSlider, countdownWidthMaxLabel]];
    ...
    NSStackView *countdownSection = [NSStackView stackViewWithViews:@[showCountdown, countdownDetailStack]];
